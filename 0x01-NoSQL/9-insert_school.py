...
def insert_school(mongo_collection, **kwargs):
    """
    Inserts a new document into a MongoDB collection based on provided keyword arguments.

    Args:
        mongo_collection (pymongo.collection.Collection): The collection object to insert into.
        **kwargs: Keyword arguments representing fields and values for the new document.
